...
$fecha_cont = pg_escape_string($conn, $_POST['fecha_cont'] ?? '');
$antiguedad = pg_escape_string($conn, $_POST['antiguedad'] ?? '');

// Validaciones básicas
if (empty($codigo) || empty($nombre) || empty($carrera) || empty($correo) || empty($fecha_cont) || empty($antiguedad)) {
...
$query_verificar_correo = 'SELECT 1 FROM "Profesores" WHERE correo = $1';
...
$query_insert = 'INSERT INTO "Profesores" (codigo, nombre, carrera, correo, fecha_cont, antiguedad) 
                 VALUES ($1, $2, $3, $4, $5, $6)';
$params = [$codigo, $nombre, $carrera, $correo, $fecha_cont, $antiguedad];
