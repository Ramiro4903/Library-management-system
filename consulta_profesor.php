...
$query = 'SELECT codigo, nombre, carrera, correo, fecha_cont, antiguedad FROM "Profesores" ORDER BY nombre';
...
$profesores = pg_fetch_all($result);
pg_close($conn);
                    ...
                    <table class="tabla-alumnos">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($profesor['fecha_cont']) ?></td>
                                <td><?= htmlspecialchars($profesor['antiguedad']) ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
