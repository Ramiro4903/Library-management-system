    ...
    <div class="container">       
        ...
        <div class="quick-actions">
            <div class="action-card">
                <h3><i class="fas fa-book"></i> Registrar Libros</h3>
                <p>Registre nuevos libros</p>
                <a href="altas_libros.php" class="button">Acceder</a>
            </div>
            
            <div class="action-card">
                <h3><i class="fas fa-search"></i> Consultas generales</h3>
                <p>Consulte la información de todos los libros previamente registrados</p>
                <a href="buscar_libros.php" class="button">Buscar</a>
            </div>
